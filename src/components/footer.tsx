    ...
    <footer className="py-12 border-t border-white/5">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-6">
              <Image src="/logo-white.svg" alt="Logo" width={140}  height={140} />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-muted-foreground">
              ...
              <li><Link href="#" className="hover:text-white transition-colors">{t.footer.cases}</Link></li>
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-muted-foreground">
          <p>© {currentYear} BuilDev. {t.footer.rights}</p>
